            ...
            if(result['state'] === 'true'){
                ...
                result["labels"].forEach(function (elem) {
                    _lables.push({
                        ...
                        logoUrl: '../../resources/img/logo.png',
                ...
                opt = {
                    ...
                    url: '../db/' + imgurl ,
                    // lables: [
                    //     { position: { lon: -72.00, lat: 9.00 }, logoUrl: 'resources/img/logo.png', text: '蓝窗户' },
                    //     { position: { lon: 114.12, lat: 69.48 }, logoUrl: 'resources/img/logo.png', text: '一片云彩很长很长很长' },
                    //     { position: { lon: 132.48, lat: -12.24 }, logoUrl: 'resources/img/logo.png', text: '大海' }
                    // ],
                    lables: _lables,
